...
import br.gamacase.myapp.service.MetaService;
...
/**
 * REST controller for managing {@link br.gamacase.myapp.domain.Meta}.
 */
@RestController
...
public class MetaResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<MetaDTO>> getAllMetas(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
